...
# they've been, and now they want to show Charlie their entire collection. However, Charlie doesn't
# like this sessions, since the motive usually repeats. He isn't fond of seeing the Eiffel tower 40 times. '
...
# times without reordering. For example if N = 2, and the input is [1,2,3,1,2,1,2,3], you take [1,2,3,1,2], drop
...
def delete_nth(order,max_e):
    ...
    for ord in order:
        if occurences.count(ord) < max_e:
            occurences.append(ord)
    return occurences
